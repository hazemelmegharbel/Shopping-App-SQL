...
db.insertCustomer('100000001', 'Evan', 'Mulliamy', '0')
db.insertCustomer('100000111', 'Teresa', 'McLaughland', '0')
db.insertCustomer('100011111', 'Candice', 'Lovelace', '0')
db.insertCustomer('222222222', 'Jimmy', 'Wu', '0')
db.insertCustomer('444444444', 'Charlie', 'Smith', '0')
db.insertCustomer('555555555', 'Sophie', 'Wood', '0')
db.insertCustomer('666666666', 'Cameron', 'Samson', '0')
db.insertCustomer('777777777', 'Samantha', 'Smith', '0')
...
db.insertCustomerList('4', 'List',  '2021-02-20', '777777777')
db.insertCustomerList('1', 'Listing',  '2021-03-21', '555555555')
db.insertCustomerList('2', 'Listed',  '2021-03-20', '100011111')
...
#insertGroupMembers(groupID, memberID, UsesList)
db.insertGroupMembers('1000001', '100011111', '2')
db.insertGroupMembers('1000002', '222222222', '1')
db.insertGroupMembers('1000022', '666666666', '4')
db.insertGroupMembers('1000032', '666666666', '4')
db.insertGroupMembers('1000032', '100000111', '5')
db.insertGroupMembers('1000032', '777777777', '4')
db.insertGroupMembers('1000044', '555555555', '1')
...
db.insertRating('444444444', '100000001', 1, 0)
db.insertRating('222222222', '555555555', 1, 0)
db.insertRating('100000111', '555555555', 1, 0)
db.insertRating('777777777', '555555555', 0, 1)
db.insertRating('100000111', '100011111', 0, 1)
db.insertRating('666666666', '100011111', 0, 1)
db.insertRating('100000001', '100011111', 1, 0)
...
db.insertListItem('Instant Noodles', '1', '222222222', '6')
db.insertListItem('Instant Noodles', '1', '555555555', '2')
db.insertListItem('Instant Noodles', '2', '100011111', '2')
db.insertListItem('Instant Noodles', '4', '666666666', '3')
db.insertListItem('Hand Sanitizer', '1', '222222222', '6')
db.insertListItem('Hand Sanitizer', '1', '555555555', '2')
db.insertListItem('Hand Sanitizer', '2', '100011111', '2')
